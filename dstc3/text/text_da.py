...
class Memory4BaseHD(object):
    ...
    def get_act_slot_vocab(self, filename):
        ...
        vocab = sorted(list(set(acts+slots)))
...
if __name__ == '__main__':
    ...
    dir_name = 'manual-da/'
    dstc2_memory.build_save_memory(dir_name+'seed.train', dir_name+'class.all', dir_name+'seed.memory.pt')
