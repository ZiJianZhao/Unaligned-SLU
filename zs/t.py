...
if __name__ == '__main__':
    ...
    #dir_name = 'manual-da/'
    #dstc2_memory.build_save_memory(dir_name+'ttp/m1.v2.3-3.3best.train',
    #        dir_name+'dstc2.3.all.class', dir_name+'ttp/m1.v2.3-3.3best.train.memory.pt')
    dir_name = 'manual/'
    dstc2_memory.build_save_memory(dir_name+'dstc2train.all.3seed',
            dir_name+'dstc2.3.all.class', dir_name+'dstc2train.all.3seed.memory.pt')
