...
experiment=dstc3-da
data_root=../dstc3-st/manual-da/del/
memory_path=memory.pt
train_file=dstc3.train
valid_file=dstc3.valid

load_model=dst2.train.del.pt
save_model=dst2.train.del.pt
#save_model=dst2.train.3train.del.pt
...
save_file=decodes/dstc2train.on.test.1
nbest=1

python da/base/main.py -mode $mode -experiment $experiment -data_root $data_root \
