...
class Memory4WCNHD(object):

    """Class used to process DSTC2 wcns and save the processed contents.
    
    Args:
        - Need settings:
            * train_file: containing pairs of dict <wcn, act-slot-pair triples>.
    ...
    def __init__(self):
        super(Memory4WCNHD, self).__init__()
