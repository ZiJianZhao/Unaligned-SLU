...
from xslu.modules import Embedding, EncoderRNN, Attention, BertModel, BertConfig, \
...
class Encoder2Decoder(nn.Module):
    ...
    def forward(self, hiddens):
        ...
        h = hiddens[0].view(-1, self.dec_hid_dim)
        c = hiddens[1].view(-1, self.dec_hid_dim)
...
class LSTMDecoder(nn.Module):
    ...
    def __init__(self, word_emb, act_emb, slot_emb, class_size, hid_dim, dropout):
        ...
        self.attn_lin = nn.Linear(hid_dim + fea_dim, hid_dim)
        self.attn_func = Attention('dot', hid_dim, hid_dim)
        # pointer network
