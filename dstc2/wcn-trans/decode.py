...
from dataloader import  ActDataset, SlotDataset, ValueDataset, SLUDataset, process_cn_example
...
def decode_act(model, cnet, memory, cuda):
    ...
    data, lengths = ActDataset.data_info(cnet, memory, cuda)
    # Model processing
    ## encoder
