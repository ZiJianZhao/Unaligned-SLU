...
class OneBestIter4STC(object):
    ...
    Args:
        ...
        word2idx: word to idx
        class2idx: class to idx
    ...
    def __init__(self, filename, word2idx, class2idx, batch_size, cuda, epoch_shuffle, batch_sort=True):

        super(OneBestIter4STC, self).__init__()
        ...
        self.datas = self.convert_file_to_ids(filename)
    ...
    def __next__(self):
        ...
        data = [self.datas[i] for i in index]
        ...
        return enc_data, enc_length, label_data, raw_classes, indices
